...
import { SortableOptions, StartPositionOffset, Transform, EventDetails } from './definitions';
...
function augmentStartDistance(ev : any, startX : any, startY : any) : StartPositionOffset {
...
{
    return sortable => {
        const dom$ = (xs.fromObservable(sortable as any) as Stream<VNode>).remember()
